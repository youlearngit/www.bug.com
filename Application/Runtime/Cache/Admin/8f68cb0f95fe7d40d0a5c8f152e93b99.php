			...
			<div class="content-wrapper">
				...
				<section class="content">
					...
					<div class="col-md-12">
						...
						<!--form start-->
						<form action="/index.php/Admin/Privilege/add.html" method="post" id="myform" name="myform" enctype="multipart/form-data">
							<div class="card card-info">
								...
								<div class="card-body">									
										...
										<div class="input-group">
											<select name="parentid" id="catid" class="required">
                                                                                                <option value="0">顶级权限</option>
                                                                                                  <?php if(is_array($pris)): $i = 0; $__LIST__ = $pris;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php if($vo['parentid'] != 0): ?>|<?php endif; echo str_repeat('-', $vo['level']*3); echo ($vo["pri_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
									...
									<div class="form-group">
										...
										<div class="input-group">
											<input name="pri_name" type="text" class="form-control" id="text2" value="" placeholder="请输入权限名称">
									...
									<div class="form-group">
										...
										<div class="input-group">
											<input name="mname" type="text" class="form-control" id="text3" value="" placeholder="请输入模块名称">
									...
									<div class="form-group">
										...
										<div class="input-group">
											<input name="cname" type="text" class="form-control" id="text4" value="" placeholder="请输入控制器名称">
									...
									<div class="form-group">
										...
										<div class="input-group">
											<input name="aname" type="text" class="form-control" id="text5" value="" placeholder="请确认方法">
