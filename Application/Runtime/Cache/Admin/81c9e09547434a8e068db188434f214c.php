	              ...
	              <div class="card-header">
	                <span class="card-title">会员管理</span>
                        <button type="button" class="btn btn-primary btn-sm" style="float: right;"> 
	                 	<a href="/index.php/Admin/User/add" style="text-decoration:  none;color: white;display: block;cursor: pointer;">
	                 		添加</a>
	                 </button>
	              </div>
...
<!-- form start -->
	              <form role="form">
		              <table class="table table-bordered">
												...
												<tr>
													<th><font color="black">ID</font></th>
														...
														<th><font color="black">登录名</font></th>
                                                                                                                <th><font color="black">登录角色</font></th>
											...
											<tbody>
					                            ...
					                            <td><button class="btn btn-success"><i class="fa fa-edit"></i><a href="/index.php/Admin/User/edit/id/<?php echo ($vo["id"]); ?>"style="color: white;text-decoration: none;">&nbsp;编辑</a></button>
					                    <?php if($vo['id'] != 1): ?><button class="btn btn-danger"><i class="fa fa-table"></i><a onclick="return confirm('确定删除吗?');" href="/index.php/Admin/User/del/id/<?php echo ($vo["id"]); ?>"style="color: white;text-decoration: none;">&nbsp;删除</a></button<?php endif; ?>
													</td>
                ...
                <div class="list-page"><div style="margin: auto;"><?php echo ($page); ?></div></div>
            </div>
        </div>
     </section>
