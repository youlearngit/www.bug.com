			...
			<div class="content-wrapper">
				...
				<section class="content">
					...
					<div class="col-md-12">
						...
						<!--form start-->
						<form action="/index.php/Admin/Admin/add" method="post" id="myform" name="myform" enctype="multipart/form-data">
								...
								<div class="card-body">
									...
									<div class="form-group">
										...
										<div class="input-group">
											<input name="username" type="text" class="form-control" id="text1" value="" placeholder="请输入账号">
