...
<!-- form start -->
	              <form action="/index.php/Admin/Role/edit/id/3" method="post" id="myform" name="myform" enctype="multipart/form-data">
		                ...
		                <div class="card-body">
			                  ...
			                  <div class="form-group" >
			                 	...
			                 	<input name="rolename" type="text" class="form-control" id="name" value="<?php echo ($roleres["rolename"]); ?>" placeholder="请输入名称">
