            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <button type="button" class="btn btn-primary btn-sm" style="float: right;"> 
                        <a href="/index.php/Admin/Role/add.html" style="text-decoration:  none;color: white;display: block;cursor: pointer;">
                            <b>添加新角色</b></a>
                    </button>
                </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center;"><font color="black">角色名称</font></th>
                                <th style="text-align: center;"><font color="black">角色权限</font></th>
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td style="text-align: center;"><button class="btn btn-success"><i class="fa fa-edit"></i><a href="/index.php/Admin/Role/edit/id/<?php echo ($vo["id"]); ?>" style="color:white;">&nbsp;&nbsp;编辑</a></button>

                                <button class="btn btn-danger"><i class="fa fa-table"></i><a onclick="return confirm('确定删除吗?');" href="/index.php/Admin/Role/del/id/<?php echo ($vo["id"]); ?>" style="color:white;">&nbsp;&nbsp;删除</a></button>
