	              ...
	              <div class="card-header">
	                <span class="card-title">文章列表</span>
                        <button type="button" class="btn btn-primary btn-sm" style="float: right;"> 
	                 	<a href="/index.php/Admin/Page/add.html" style="text-decoration:  none;color: white;display: block;cursor: pointer;">
	                 		<b>添加新文章</b></a>
	                 </button>
	              </div>
							...
							<thead>
								<tr>
									<th style="text-align: center;"><font color="black">ID</font></th>
										...
										<th style="text-align: center;"><font color="black">文章标题</font></th>
							...
							<tbody>
								<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									...
									<td><?php echo ($vo["title"]); ?></td>
                                                                        ...
                                                                        <td style="text-align: center;"><button class="btn btn-success"><i class="fa fa-edit"></i><a href="/index.php/Admin/Page/upd/id/<?php echo ($vo["id"]); ?>" style="color:white;">&nbsp;&nbsp;编辑</a></button>
                                                               
                                                                            <button class="btn btn-danger"><i class="fa fa-table"></i><a onclick="return confirm('确定删除吗?');" href="/index.php/Admin/Page/del/id/<?php echo ($vo["id"]); ?>" style="color:white;">&nbsp;&nbsp;删除</a></button
